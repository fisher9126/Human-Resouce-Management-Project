    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/v1/payroll/me").authenticated()
                .requestMatchers("/api/v1/reports/**").hasAnyRole("ADMIN", "MANAGER")
                .requestMatchers("/api/v1/payroll/**").hasAnyRole("ADMIN", "MANAGER")
                .requestMatchers("/api/v1/contracts/**").hasRole("ADMIN")
